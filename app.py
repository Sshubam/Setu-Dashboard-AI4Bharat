...
# Set your environment variable to the path of your Google Cloud service account key
...
def get_doc_pdf(lang: str):
    ...
    # Ensure the selected document is not verified
...
if st.session_state["authentication_status"] == True:
    ...
    try:
        ...
        db.collection(f"pdf_docs_info").document("docs_done").set({"doc_ids": []})
        pdf_done_docs_ids = []
    ...
    with url_page:
        ...
        st.write(f'You have completed {user_info["n_done"]} documents')
